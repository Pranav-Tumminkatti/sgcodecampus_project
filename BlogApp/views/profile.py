...
def dashboard():
    ...
    return render_template('profile/dashboard.html',num_blogs=num_blogs,num_views=num_views,num_likes=num_likes,num_comments=num_comments,unread=unread_count) 
...
def ext_profile(id): 
    ...
    if records is None:
        ...
        return render_template('profile/ext_profile.html', profile=records,form=form, num_blogs=num_blogs, num_views=num_views, num_comments=num_comments)    
    else:
        return render_template('profile/ext_profile.html', profile=records,form=form, num_blogs=num_blogs, num_views=num_views, num_comments=num_comments) 
